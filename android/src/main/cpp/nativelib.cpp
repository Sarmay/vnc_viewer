...
Java_com_sarmay_vnc_1viewer_VncClient_rfbInitClient(JNIEnv *env,
                                                                            jobject thiz,
                                                                            jstring host_name,
                                                                            jint port,
                                                                            jstring password,
                                                                            jobject surface,
                                                                            jobject client_call_back) {
...
Java_com_sarmay_vnc_1viewer_VncClient_startRfbClient(JNIEnv *env,
                                                                             jobject thiz,
                                                                             jlong client_id) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_sarmay_vnc_1viewer_VncClient_sendPointer(JNIEnv *env, jobject thiz,
                                                                          jlong client_id, jint x,
                                                                          jint y, jint mask) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_sarmay_vnc_1viewer_VncClient_sendKeyEvent(JNIEnv *env, jobject thiz,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_sarmay_vnc_1viewer_VncClient_closeRfbClient(JNIEnv *env,
                                                                             jobject thiz,
                                                                             jlong client_id) {
    auto client = VncClient::getVncClient(client_id);
    client->close();
